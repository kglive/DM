...
export default new Router({
  routes: [
    ...
    {
      path: '/index',
      components: { index: dmHeaderSidenav },
      children: [
        { path: '', redirect: 'main' },
        ...
        * */
        ...
        { path: 'bingWallpaper', name: 'bingWallpaper', component: () => import('@/components/other/WonderfulBingWallpaper') },
        { path: 'errordel', name: 'errordel', component: () => import('@/components/other/errordel') },
      ]
    }
  ]
})
