<template>
  <section id="main-index">
    ...
    <p>{{ name }} - {{ age }}</p>
    <p>{{ guolv }}</p>
    <el-button @click="a">click</el-button>
    <el-button @click="addage">addage</el-button>
    <el-button @click="minusAge">minusage</el-button>
    <el-button @click="addagepro">addagepro</el-button>
  </section>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      // 将vuex中的数据添加到this的vuex bindings(类似data)上，其他需要使用的地方直接用this访问变量
      ...mapState([
        'name',
        'age'
      ]),
